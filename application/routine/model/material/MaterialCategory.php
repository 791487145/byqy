 ...
 * @day: 2017/11/02
 */
namespace app\routine\model\material;
 ...
 */
class MaterialCategory extends ModelBasic
{
    use ModelTrait;
    ...
    public static function getTierList($model = null)
    {
        ...
        return $model->where('is_del','eq',0)->where('status','eq',1)->where('hidden','eq',0)->select()->toArray();
    }
