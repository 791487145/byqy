...
use app\admin\model\store\StoreProductAttrResult as StoreProductAttrResultmodel;
...
class StoreProduct extends ModelBasic
{
    ...
    public static function decProductStock($num,$productId,$unique = '')
    {
        if($unique){
            ...
            $res = false !== StoreProductAttrResultmodel::decProductAttrStock($productId,$unique,$num);
