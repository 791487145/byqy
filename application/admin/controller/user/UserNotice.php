...
class UserNotice extends AuthController
{
    ...
    public function create(){
        ...
        $f[] = Form::radio('type','消息类型',1)->options([['label'=>'系统消息','value'=>1],['label'=>'用户通知','value'=>2],['label'=>'公告','value'=>3]]);
    ...
    public function edit($id)
    {
        ...
        $f[] = Form::radio('type','消息类型',$notice["type"])->options([['label'=>'系统消息','value'=>1],['label'=>'用户通知','value'=>2],['label'=>'公告','value'=>3]]);
