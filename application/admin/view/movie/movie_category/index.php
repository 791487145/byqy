...
<script>
    ...
    layList.tableList('List',"{:Url('category_list')}",function (){
        return [
            ...
            {field: 'title', title: '分类名称',edit:'title'},
    ...
    layList.switch('is_show',function (odj,value) {
        if(odj.elem.checked==true){
            layList.baseGet(layList.Url({c:'movie.movie_category',a:'set_show',p:{is_show:1,id:value}}),function (res) {
                layList.msg(res.msg);
            });
        }else{
            layList.baseGet(layList.Url({c:'movie.movie_category',a:'set_show',p:{is_show:0,id:value}}),function (res) {
                layList.msg(res.msg);
            });
        }
    });
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            case 'delstor':
                var url=layList.U({c:'movie.movie_category',a:'delete',q:{id:data.id}});
