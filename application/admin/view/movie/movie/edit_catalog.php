                    ...
                    <form class="form-horizontal" id="signupForm">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="input-group">
                                    ...
                                    <input maxlength="64" placeholder="请在这里输入标题" name="catalog_title" class="layui-input" id="catalog_title" value="{$catalog->catalog_title}">
                                    <input type="hidden" id="type" name="type" value="{$catalog->type}">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea  id="synopsis" name="synopsis" class="layui-input" style="height:80px;resize:none;line-height:20px;color:#333;">{$catalog->description}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="form-control" style="height:auto">
                                    ...
                                    <div class="row nowrap">
                                        <div class="col-xs-3" style="width:160px">
                                            ...
                                            {if condition="$catalog->pic"}
                                            <div class="upload-image-box transition image_img" style="height: 80px;background-repeat:no-repeat;background-size:contain;background-image:url({$catalog->pic})">
                                    ...
                                    <input type="hidden" name="image" id="image_input" value="{$catalog->pic}"/>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="input-group">
                                    <label >试听：</label>
                                    <input type="radio" name="is_free" class="layui-radio " value="0" {if $catalog->is_free==0}checked{/if}>  否
                                    <input type="radio" name="is_free" class="layui-radio" value="1" style="padding-left: 20px" {if $catalog->is_free==1}checked{/if}>  是
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea type="text/plain" id="myEditor" style="width:100%;">{$catalog->content}</textarea>
                            </div>
                        </div>
