...
<head>
    ...
    <title>登录管理系统 -  Powered by <?= \service\SystemConfigService::get('site_name') ?>!</title>
...
<div class="footer" style=" position: fixed;bottom: 0;width: 100%;left: 0;margin: 0;opacity: 0.8;">
    <div class="pull-right">© 2017-2019 <a href="<?= \service\SystemConfigService::get('site_url') ?>" target="_blank"><?= \service\SystemConfigService::get('site_name') ?></a>
    </div>
</div>
