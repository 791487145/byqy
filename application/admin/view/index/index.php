...
<head>
    ...
    <title><?= \service\SystemConfigService::get('site_name') ?></title>
    <!--[if lt IE 9]>
...
<div id="wrapper">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element admin_open">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li><a class="admin_close" target="_blank" href="https://service.7reach.cn/">联系我们</a>
                            </li>
                            <li class="divider"></li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer"  @touchmove.prevent>
            <div class="pull-right">© 2014-2018 <a href="<?= \service\SystemConfigService::get('site_url') ?>" target="_blank"><?= \service\SystemConfigService::get('site_name') ?></a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
